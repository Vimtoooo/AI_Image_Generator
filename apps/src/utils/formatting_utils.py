class FormattingUtils:
    """
    Utility class for handling string formatting, timestamp parsing, prompt assembly,
    ...
    @classmethod
    def format_positive_prompt(cls, master_prompt: str, scene_description: str) -> str:
        """
